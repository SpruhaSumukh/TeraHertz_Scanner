function new_img = avg_with_nn( image,  number_of_nn)
%AVG_WITH_NN Summary of this function goes here
...
for l = number_of_nn+1:x-number_of_nn 
    for m = number_of_nn+1:y-number_of_nn
            for ind = 1:a
                new_img(l,m) = image(l+(C(ind, 1)), m+(C(ind, 2))) + initial_sum(x-number_of_nn, y-number_of_nn);
